...
export const venue = {
  ...
  // 용산가족공원 야외예식장(연못광장, 공원 남측) 좌표
  lat: 37.52135,
  lng: 126.98405,
  /** 길찾기 앱 딥링크 (앱 미설치 시 web 폴백 사용) */
  nav: {
    naverApp: `nmap://route/public?dlat=37.52135&dlng=126.98405&dname=${encodeURIComponent(
      "용산가족공원 야외예식장"
    )}`,
    naverWeb: "https://map.naver.com/p/search/용산가족공원 야외예식장",
    kakaoApp: "kakaomap://route?ep=37.52135,126.98405&by=PUBLICTRANSIT",
    kakaoWeb: "https://map.kakao.com/?q=용산가족공원 야외예식장",
    tmapApp: `tmap://route?goalx=126.98405&goaly=37.52135&goalname=${encodeURIComponent(
      "용산가족공원 야외예식장"
    )}`,
